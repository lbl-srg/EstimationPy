...
def plotBasic(time,timeSamples,startTime,stopTime,X,Y,U,Um,Z,Xhat,P,Yhat,CovY,Xsmooth,Psmooth,faultStatus,probFault):
	...
	ax0.plot(1.0/3600.0*time,U[:,0],'k',label='$T_{CH IN}$')
	ax0.plot(1.0/3600.0*timeSamples,Um[:,0],'ko',label='$T_{CH IN}^{SAMPLED}$',alpha=0.2)
	ax0.plot(1.0/3600.0*time,U[:,1],'g',label='$T_{CD IN}$')
	ax0.plot(1.0/3600.0*timeSamples,Um[:,1],'go',label='$T_{CD IN}^{SAMPLED}$',alpha=0.2)
	
	ax0.plot(1.0/3600.0*time,Y[:,0],'b',label='$T_{CH}$')
	ax0.plot(1.0/3600.0*timeSamples,Z[:,0],'bo',label='$T_{CH}^{SAMPLED}$',alpha=0.2)
	ax0.plot(1.0/3600.0*time,Y[:,1],'r',label='$T_{CD}$')
	ax0.plot(1.0/3600.0*timeSamples,Z[:,1],'ro',label='$T_{CD}^{SAMPLED}$',alpha=0.2)
	
	ax0.set_xlabel('Time [h]')
	ax0.set_ylabel('Temperatures [$\circ$C]')
	ax0.set_xlim([startTime/3600.0, stopTime/3600.0])
	ax0.set_ylim([0, 45])
	legend = ax0.legend(loc='upper center',bbox_to_anchor=(0.5, 1.1), ncol=4, fancybox=True, shadow=True)
	legend.draggable()
	ax0.grid(False)
	plt.savefig('DATA_zero.pdf',dpi=400, bbox_inches='tight', transparent=True,pad_inches=0.1)
	...
	fig1b = plt.figure()
	fig1b.set_size_inches(10,5)
	ax1b  = fig1b.add_subplot(111)
	ax1b.plot(1.0/3600.0*time,U[:,0],'k',label='$T_{CH IN}$')
	ax1b.plot(1.0/3600.0*timeSamples,Um[:,0],'ko',label='$T_{CH IN}^{SAMPLED}$',alpha=0.2)
	ax1b.plot(1.0/3600.0*time,U[:,2],'g',label='$T_{CH}^{SP}$')
	ax1b.plot(1.0/3600.0*time,Y[:,0],'b',label='$T_{CH}$')
	ax1b.plot(1.0/3600.0*timeSamples,Z[:,0],'bo',label='$T_{CH}^{SAMPLED}$',alpha=0.2)
	ax1b.set_xlabel('Time [h]')
	ax1b.set_ylabel('Temperatures [$\circ$C]')
	ax1b.set_xlim([startTime/3600.0, stopTime/3600.0])
	#legend = ax1b.legend(loc='upper center',bbox_to_anchor=(0.5, 1.1), ncol=4, fancybox=True, shadow=True)
	#legend.draggable()
	ax1b.grid(False)
	plt.savefig('a_bis.pdf',dpi=400, bbox_inches='tight', transparent=True,pad_inches=0.1)
	...
	ax2b.plot(1.0/3600.0*time,U[:,1],'k',label='$T_{CD IN}$')
	ax2b.plot(1.0/3600.0*timeSamples,Um[:,1],'ko',label='$T_{CD IN}^{SAMPLED}$',alpha=0.2)
	ax2b.plot(1.0/3600.0*time,Y[:,1],'r',label='$T_{CD}$')
	ax2b.plot(1.0/3600.0*timeSamples,Z[:,1],'ro',label='$T_{CD}^{SAMPLED}$',alpha=0.2)
	ax2b.set_xlabel('Time [h]')
	ax2b.set_ylabel('Temperatures [$\circ$C]')
	ax2b.set_xlim([startTime/3600.0, stopTime/3600.0])
	#legend = ax2b.legend(loc='upper center',bbox_to_anchor=(0.5, 1.1), ncol=4, fancybox=True, shadow=True)
	#legend.draggable()
	ax2b.grid(False)
	plt.savefig('b_bis.pdf',dpi=400, bbox_inches='tight', transparent=True,pad_inches=0.1)
	...
	ax4.set_ylim([60, 120])
	legend = ax4.legend(loc='upper center',bbox_to_anchor=(0.2, 1.05), ncol=1, fancybox=True, shadow=True)
	legend.draggable()
	ax4.grid(False)
	...
	legend = ax5.legend(loc='upper center',bbox_to_anchor=(0.5, 1.1), ncol=4, fancybox=True, shadow=True)
	legend.draggable()
	ax5.grid(False)
	...
	legend = ax6.legend(loc='upper center',bbox_to_anchor=(0.35, 1.05), ncol=3, fancybox=True, shadow=True)
	legend.draggable()
	ax6.grid(False)
	...
	legend = ax7.legend(loc='upper center',bbox_to_anchor=(0.6, 1.1), ncol=4, fancybox=True, shadow=True)
	legend.draggable()
	ax7.grid(False)
	...
	ax9.plot(1.0/3600.0*timeSamples,faultStatus[:,0,0],'r',label='$Sensor$')
	ax9.plot(1.0/3600.0*timeSamples,faultStatus[:,1,0],'k',label='$Sensor^{SMOOTH}$')
	...
	ax10.plot(1.0/3600.0*timeSamples,faultStatus[:,1,1],'k',label='$Chiller^{SMOOTH}$')
	...
	legend = ax10.legend(loc='upper center',bbox_to_anchor=(0.85, 1.1), ncol=1, fancybox=True, shadow=True)
	legend.draggable()
	ax10.grid(False)
	
	ax10  = fig10.add_subplot(212)
	ax10.plot(1.0/3600.0*timeSamples,probFault[:,0,1],'r',label='$P_{fault}^{Chiller}$')
	ax10.plot(1.0/3600.0*timeSamples,probFault[:,1,1],'k',label='$P_{fault}^{Chiller}$')
	ax10.set_xlabel('Time [h]')
	ax10.set_ylabel('Probability of fault [%]')
	ax10.set_xlim([startTime/3600.0, stopTime/3600.0])
	ax10.set_ylim([0, 100])
	legend = ax10.legend(loc='upper center',bbox_to_anchor=(0.85, 1.05), ncol=1, fancybox=True, shadow=True)
	legend.draggable()
	ax10.grid(False)
	...
	ax11.plot(1.0/3600.0*timeSamples,faultStatus[:,0,2],'r',label='$Valve_1$')
	ax11.plot(1.0/3600.0*timeSamples,faultStatus[:,1,2],'k',label='$Valve_1^{SMOOTH}$')
	...
	legend = ax11.legend(loc='upper center',bbox_to_anchor=(0.3, 1.05), ncol=1, fancybox=True, shadow=True)
	legend.draggable()
	ax11.grid(False)
	
	ax11  = fig11.add_subplot(212)
	ax11.plot(1.0/3600.0*timeSamples,probFault[:,0,2],'r',label='$P_{fault}^{Valve_1}$')
	ax11.plot(1.0/3600.0*timeSamples,probFault[:,1,2],'k',label='$P_{fault}^{Valve_1}$')
	ax11.set_xlabel('Time [h]')
	...
	ax12.plot(1.0/3600.0*timeSamples,faultStatus[:,0,3],'r',label='$Valve_2$')
	...
	legend = ax12.legend(loc='upper center',bbox_to_anchor=(0.55, 1.0), ncol=1, fancybox=True, shadow=True)
	legend.draggable()
	ax12.grid(False)
	
	ax12  = fig12.add_subplot(212)
	ax12.plot(1.0/3600.0*timeSamples,probFault[:,0,3],'r',label='$P_{fault}^{Valve_2}$')

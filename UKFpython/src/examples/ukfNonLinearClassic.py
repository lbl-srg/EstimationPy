...
from models.nonlinearClassic.model import model
from models.nonlinearClassic.plotting import plotResults
...
for i in range(numPoints):
	if i==0:
		...
		X[i,:]= m.functionF(values) + np.dot(m.sqrtR, np.random.randn(1,n_state))

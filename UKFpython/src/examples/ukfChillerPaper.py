...
from ukf import ukf
from models.chillerExamplePaper import model
from models.chillerExamplePaper import plotting
...
# define the model
m = model.model(Ti = 80.0, Td = 0.0, K  = -0.05, b=1.0, c=1.5, CSmax = 1.0, CSmin = 0.0, dt= dt, DT=DT)
m.plotEtaPL()
...
# PLOT
plotting.plotBasic(time,timeSamples,startTime,stopTime,X,Y,U,Um,Z,Xhat,P,Yhat,covY,Xsmooth,Psmooth,faultStatus,probFault)
